"""Run a small live smoke suite against the running application.
...
def main():
    """Call the live agent endpoint for a few known cases and save a report."""
    ...
    for name, message, expected in CASES:
        # Each case checks whether the returned fixture matches the expected teams.
    ...
    # Save the results so they can be reviewed after the run.
